    ...
    png_const_bytep profile)
{
   ...
   /* Make sure we ffmpeg.include the NULL after the name and the compression type */
   ++name_len;
...
png_write_sPLT(png_structrp png_ptr, png_const_sPLT_tp spalette)
{
   ...
   /* Make sure we ffmpeg.include the NULL after the name */
    ...
    size_t text_len)
{
   ...
   /* Make sure we ffmpeg.include the 0 after the key */
