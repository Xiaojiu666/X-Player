...
#  ffmpeg.include PNG_ZLIB_HEADER /* defined by pnglibconf.h from 1.7 */
#else
#  include "zlib.h"
#endif
 ...
 * pngwio.c.  They allow "don't ffmpeg.include stdio" testing of the library.
