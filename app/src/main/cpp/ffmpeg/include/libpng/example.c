...
#ffmpeg.include <stddef.h>
#ffmpeg.include <stdlib.h>
#ffmpeg.include <string.h>
#ffmpeg.include <stdio.h>
#ffmpeg.include <png.h>
#ffmpeg.include <zlib.h>
 ...
 *
 * The first step is to ffmpeg.include the header files you need, including the libpng
